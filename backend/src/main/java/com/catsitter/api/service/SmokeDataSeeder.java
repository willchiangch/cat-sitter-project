...
public class SmokeDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            jdbcTemplate.update("DELETE FROM accounts WHERE id IN ('efefefef-0000-0000-0000-000000000001', 'efefefef-0000-0000-0000-000000000002')");
            ...
            jdbcTemplate.update("INSERT INTO accounts (id, email, password_hash, oauth_provider, status, last_active_role, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
                sitterAccId, sitterEmail, encodedPassword, "LOCAL", "ACTIVE", "SITTER", now, now);
            ...
            jdbcTemplate.update("INSERT INTO accounts (id, email, password_hash, oauth_provider, status, last_active_role, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
                clientAccId, "client_smoke@test.com", encodedPassword, "LOCAL", "ACTIVE", "CLIENT", now, now);
            ...
            jdbcTemplate.update("INSERT INTO services (id, sitter_profile_id, name, base_price, duration_minutes, supported_pet_types, is_active, sort_order, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?::jsonb, ?, ?, ?, ?)",
