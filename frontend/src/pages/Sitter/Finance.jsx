      ...
      >
        ...
        <section className="relative overflow-hidden rounded-[40px] p-8 bg-on-surface text-surface shadow-2xl">
          <div className="relative z-10 space-y-6">
            ...
            <button className="w-full py-4 bg-primary text-on-primary rounded-full text-sm font-extrabold hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-primary/20">
              Request Payout
            </button>
          </div>
